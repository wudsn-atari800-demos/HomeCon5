...
inflateStoredBlock_pageCounter  =	inflate_zp+5  ; 1 byte

inflateCodes_sourcePointer      =	inflate_zp+6  ; 2 bytes
inflateDynamicBlock_lengthIndex =	inflate_zp+6  ; 1 byte
inflateDynamicBlock_lastLength	=	inflate_zp+7  ; 1 byte
inflateDynamicBlock_tempCodes   =	inflate_zp+7  ; 1 byte

inflateCodes_lengthMinus2       =	inflate_zp+8  ; 1 byte
inflateDynamicBlock_allCodes    =	inflate_zp+8  ; 1 byte

inflateCodes_primaryCodes       =	inflate_zp+9  ; 1 byte
...
; to the memory starting from the address stored in outputPointer
	ldy	#0
;	sty 	inputPointer	;JAC!
;	sty 	outputPointer	;JAC!
	sty	getBit_buffer
inflate_blockLoop
...
inflateDynamicBlock_headerBits	.byte	GET_4_BITS,GET_5_BITS,GET_5_BITS
inflateDynamicBlock_headerBase	.byte	3,0,0  ; second byte is modified at runtime!
inflate_end
